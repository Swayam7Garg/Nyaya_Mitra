...
const situations = [
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": {
          "en": "Call 1915 (National Consumer Helpline) for guidance.",
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": {
          "en": "Submit written complaint to your organization ICC within 3 months.",
    ...
    "steps": [
      {
        ...
        "description": {
          "en": "Go to the police station having jurisdiction. e-FIR is also available online in many states.",
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "description": {
          "en": "Submit by post, in person, or online at rtionline.gov.in. Pay Rs. 10 fee.",
      ...
      },
      {
        ...
        "description": {
          "en": "Await response within 30 days. If unsatisfied, file first appeal.",
    ...
    "steps": [
      {
        ...
        "description": {
          "en": "Contact the Protection Officer (PO) in your district. Call Women Helpline 181 in emergency.",
          "hi": "अपने जिले में संरक्षण अधिकारी से संपर्क करें। आपात में 181 पर कॉल करें।"
        },
        "tip": {
          "en": "Call Women Helpline 181 or Police 100 in emergency.",
          "hi": "आपात स्थिति में 181 या 100 पर कॉल करें।"
        }
      },
      {
        "stepNumber": 2,
        ...
        "description": {
          "en": "File Form I application before the Magistrate through the Protection Officer.",
      ...
      },
      {
        ...
        "description": {
          "en": "Government Shelter Homes (Swadhar Greh) provide free temporary housing.",
  ...
  },
  {
    ...
    "steps": [
      ...
      },
      {
        ...
        "tip": {
          "en": "You can seek interim injunction to prevent further encroachment.",
  ...
  },
  {
    ...
    "description": {
      ...
      "hi": "अवैतनिक मजदूरी, अवैध कटौती, PF/ESI से इनकार, गलत बर्खास्तगी।"
    },
    "rights": [
      {
        "title": {
    ...
    "checklist": [
      ...
      },
      {
        "id": "lr3",
        "item": {
          "en": "Bank statements showing salary credits",
      ...
      },
      {
        "id": "lr5",
        "item": {
          "en": "Written communication about wage dispute",
          "hi": "वेतन विवाद के बारे में लिखित पत्राचार"
        },
        "required": false
      },
      {
    ...
    "steps": [
      {
        ...
        "description": {
          ...
          "hi": "अवैतनिक मजदूरी की सटीक राशि की गणना करें।"
        },
        "tip": {
          "en": "Keep copies of all payslips and bank statements as primary evidence.",
          "hi": "प्राथमिक साक्ष्य के रूप में सभी वेतन पर्चियों की प्रति रखें।"
        }
      },
      {
        "stepNumber": 2,
        ...
        "description": {
          "en": "Send a written demand notice to your employer via registered post, stating the amount due.",
          "hi": "नियोक्ता को रजिस्टर्ड डाक से लिखित मांग नोटिस भेजें।"
        },
        "tip": {
          "en": "Always keep the postal receipt as proof.",
      ...
      },
      {
        ...
        "description": {
          "en": "Visit your district Labour Office and file a complaint with the Labour Inspector.",
        ...
        "tip": {
          ...
          "hi": "श्रम निरीक्षक के पास रिकॉर्ड जांचने का अधिकार है।"
        }
      },
      {
        "stepNumber": 4,
        ...
        "description": {
          "en": "If Labour Inspector fails to resolve, file a claim before the Labour Court for recovery of wages.",
          "hi": "यदि समाधान न हो तो श्रम न्यायालय में दावा दर्ज करें।"
        },
        "tip": {
          "en": "Free legal aid is available through State Legal Services Authority.",
          "hi": "राज्य विधिक सेवा प्राधिकरण के माध्यम से मुफ्त सहायता उपलब्ध है।"
        }
      },
      {
        "stepNumber": 5,
        ...
        "description": {
          "en": "For PF issues, file grievance at epfigms.gov.in or call EPFO toll-free 1800-118-005.",
          "hi": "PF से संबंधित शिकायतों के लिए epfigms.gov.in पर जाएं।"
        },
        "tip": {
          "en": "EPFO can directly penalize employers under Section 14B EPF Act.",
          "hi": "EPFO EPF अधिनियम के तहत नियोक्ताओं को दंड दे सकता है।"
        }
      }
    ],
    "templateType": "labor"
