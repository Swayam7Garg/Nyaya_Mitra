...
const techStack = ['Next.js 14 (App Router)', 'TypeScript', 'Tailwind CSS', 'i18next (Hindi + English)', 'jsPDF (document generation)', 'Node.js + Express (backend)', 'MongoDB Atlas', 'OpenAI API (GPT-4o)'];
